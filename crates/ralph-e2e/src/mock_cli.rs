...
//! JSONL cassettes. It is invoked by ralph as a custom backend command.
//!
//! # Usage
//!
//! ```bash
//! # Replay a cassette (invoked by ralph as custom backend)
...
/// - Direct command payloads: `"ralph task add ..."`
