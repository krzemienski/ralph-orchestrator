...
public struct Event: Identifiable, Codable, Equatable {
    ...
    public let type: String // "tool.call", "hat.activated", "event.published", "backpressure"
    public let toolName: String?
    public let status: String? // "running", "completed", "pending", "error"
    ...
    public var displayPriority: EventPriority {
