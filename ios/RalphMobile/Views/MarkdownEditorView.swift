...
struct MarkdownEditorView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            // Sync binding value into viewModel — fixes @StateObject autoclosure timing
            // where the binding may not yet have its value when StateObject initializes
            if viewModel.content.isEmpty && !promptText.isEmpty {
                viewModel.updateContent(promptText)
            }
        }
        .task {
