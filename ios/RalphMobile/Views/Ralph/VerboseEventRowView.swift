...
/// Shared date formatters to avoid allocation on every render.
private enum EventFormatters {
...
private struct HatTransitionCard: View {
    ...
    private func formatTime(_ date: Date) -> String {
        EventFormatters.time12h.string(from: date)
    }
}
...
struct ToolCallRow: View {
    ...
    private func formatTime(_ date: Date) -> String {
        EventFormatters.time24h.string(from: date)
    }
